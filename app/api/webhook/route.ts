...
export async function POST(request: Request) {
  ...
  console.log(`[webhook] Event: ${event.event}, FID: ${fid}`);

  switch (event.event) {
    case "frame_added":
      console.log("[webhook] Frame added by user", fid);
      break;
    case "frame_removed":
      console.log("[webhook] Frame removed by user", fid);
      break;
    case "notifications_enabled":
      console.log("[webhook] Notifications enabled by user", fid);
      break;
    case "notifications_disabled":
      console.log("[webhook] Notifications disabled by user", fid);
      break;
  }
